...
`, "config.yaml")
	...
	t.Setenv("YOUBAN_PUBLISH_MEDIA_BULK_CONCURRENCY", "3")
	t.Setenv("YOUBAN_PUBLISH_MEDIA_BULK_SHARDS", "16")
	t.Setenv("YOUBAN_PUBLISH_MEDIA_REALTIME_WEIGHT", "24")
	t.Setenv("YOUBAN_PUBLISH_AUTO_DELETE_CONCURRENCY", "32")
	...
	t.Setenv("YOUBAN_TELEGRAM_COLLECTOR_ENABLED", "true")
	...
	assertCfg("youbanPublish.queue.mediaBulkConcurrency", "3")
