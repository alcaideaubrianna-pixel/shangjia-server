...
type sSysPublish struct {
	...
	attemptTimeoutServer  *asynq.Server
	backgroundQueueServer *asynq.Server
	cycleQueueServer      *asynq.Server
...
func init() {
	...
	collectorservice.RegisterAccountTaskHandler(collectorin.AccountTaskTypeManagedBotUsernameCheck, accountTaskHandler)
	collectorservice.RegisterAccountTaskHandler(collectorin.AccountTaskTypeManagedBotCreate, accountTaskHandler)
	collectorservice.RegisterAccountTaskHandler(collectorin.AccountTaskTypeChannelMemberSync, accountTaskHandler)
	collectorservice.RegisterAccountTaskHandler(collectorin.AccountTaskTypeTgAccountRefresh, accountTaskHandler)
	collectorservice.RegisterAccountTaskHandler(collectorin.AccountTaskTypeMessageRepair, accountTaskHandler)
	collectorservice.RegisterAccountTaskHandler(collectorin.AccountTaskTypeMessageRepairScan, accountTaskHandler)
