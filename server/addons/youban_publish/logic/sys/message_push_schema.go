...
func ensureMessagePushMysqlTables(ctx context.Context) error {
	statements := []string{
		...
		"ALTER TABLE `hg_youban_publish_message_template` ADD COLUMN `button_config` text NOT NULL DEFAULT ''",
		...
		"ALTER TABLE `hg_youban_publish_message_push_plan` ADD COLUMN `push_mode` varchar(16) NOT NULL DEFAULT 'bot'",
		"ALTER TABLE `hg_youban_publish_tg_job` ADD COLUMN `push_mode` varchar(16) NOT NULL DEFAULT 'bot'",
