...
WITH parent AS (
  ...
  FROM (VALUES
    ...
    ('旧站导入', 'youbanPublishImportTask', '/youban_publish/publish/importTask/list,/youban_publish/publish/importTask/create,/youban_publish/publish/importTask/view,/youban_publish/publish/importTask/start,/youban_publish/publish/importTask/cancel,/youban_publish/publish/importTask/retry', 35),
