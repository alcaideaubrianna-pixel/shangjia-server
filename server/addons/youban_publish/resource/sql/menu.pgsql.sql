...
WITH parent AS (
  ...
  FROM (VALUES
    ...
    ('笔记资料', 'youbanPublishProfile', '/youban_publish/publish/profile/list,/youban_publish/publish/profile/view,/youban_publish/publish/profile/save,/youban_publish/publish/profile/delete,/youban_publish/publish/profile/review', 34),
