...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_ybp_task_note_scope" ON "hg_youban_publish_task" ("tenant_id", "account_id", "updated_at" DESC, "id" DESC) WHERE "deleted_at" IS NULL;
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_ybp_task_profile_tenant" ON "hg_youban_publish_task" ("profile_id", "tenant_id") WHERE "deleted_at" IS NULL;
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_ybp_task_search_scope" ON "hg_youban_publish_task" ("tenant_id", "account_id", "profile_id") WHERE "deleted_at" IS NULL;
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_ybp_task_profile_status" ON "hg_youban_publish_task" ("profile_id", "status", "id" DESC) WHERE "deleted_at" IS NULL;
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_ybp_media_task_active" ON "hg_youban_publish_media" ("task_id", "deleted_at", "sort_index", "id");
