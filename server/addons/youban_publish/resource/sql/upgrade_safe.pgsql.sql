...
ALTER TABLE "hg_youban_publish_cloud_resource_usage" ADD COLUMN IF NOT EXISTS "provider" varchar(32) NOT NULL DEFAULT 'legacy';
DROP INDEX IF EXISTS "uk_ybp_cloud_usage_daily";
CREATE UNIQUE INDEX "uk_ybp_cloud_usage_daily" ON "hg_youban_publish_cloud_resource_usage" ("tenant_id", "account_id", "resource_type", "provider", "scene", "usage_date");
