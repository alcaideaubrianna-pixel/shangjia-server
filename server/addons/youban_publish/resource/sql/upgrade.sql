...
ALTER TABLE `hg_youban_publish_message_template` ADD COLUMN `button_config` text NOT NULL COMMENT '按钮配置JSON';
...
CREATE TABLE IF NOT EXISTS `hg_youban_publish_collect_dedupe_source` (
  ...
  `created_at` datetime DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `uk_ybp_collect_dedupe_source` (`entry_id`,`dispatch_id`),
