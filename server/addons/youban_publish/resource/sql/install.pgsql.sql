...
CREATE TABLE IF NOT EXISTS "hg_youban_publish_collect_dispatch" (
  ...
  "profile_id" bigint NOT NULL DEFAULT 0,
  "task_id" bigint NOT NULL DEFAULT 0,
  "source_type_snapshot" varchar(32) NOT NULL DEFAULT '',
  "source_name_snapshot" varchar(255) NOT NULL DEFAULT '',
  "source_username_snapshot" varchar(128) NOT NULL DEFAULT '',
  "source_chat_id_snapshot" varchar(128) NOT NULL DEFAULT '',
  "source_message_id_snapshot" bigint NOT NULL DEFAULT 0,
  "match_json" text,
  "status" varchar(32) NOT NULL DEFAULT 'pending',
  "error_message" text,
  "created_at" timestamp DEFAULT NULL,
