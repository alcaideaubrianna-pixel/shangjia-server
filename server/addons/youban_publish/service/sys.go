...
type ISysPublish interface {
	...
	TenantVipStatus(ctx context.Context, tenantId int64) (res *sysin.TenantVipStatusModel, err error)
	ImageProcessingQuota(ctx context.Context) (res *sysin.ImageProcessingQuotaModel, err error)
	...
	ServerTgAccountUnbind(ctx context.Context, in *sysin.TgAccountDeleteInp) (err error)
	...
	AdminCollectSourceOptions(ctx context.Context, keyword string, page, perPage int) (list []*sysin.CollectSourceOptionModel, totalCount int, err error)
	...
	AdminMediaDirectUploadCreate(ctx context.Context, in *sysin.MediaDirectUploadCreateInp) (*sysin.MediaDirectUploadCreateModel, error)
	AdminMediaDirectUploadSign(ctx context.Context, in *sysin.MediaDirectUploadSignInp) (*sysin.MediaDirectUploadSignModel, error)
	AdminMediaDirectUploadComplete(ctx context.Context, in *sysin.MediaDirectUploadCompleteInp, poster *ghttp.UploadFile) (*sysin.MediaModel, error)
	...
	AdminAntiScanSegment(ctx context.Context, in *sysin.AntiScanSegmentInp) (res *sysin.AntiScanSegmentModel, err error)
	...
	QuickPushBotTemplateList(ctx context.Context, accountId int64) (list []*sysin.MessageTemplateModel, err error)
	QuickPushBotTemplateView(ctx context.Context, accountId int64, templateId int64) (res *sysin.MessageTemplateModel, err error)
	QuickPushBotTemplateUpdate(ctx context.Context, in *sysin.QuickPushBotTemplateUpdateInp) (err error)
	QuickPushBotTemplateDelete(ctx context.Context, accountId int64, templateId int64) (err error)
	...
	AccountListenerPlanList(ctx context.Context, in *sysin.ListenerPlanListInp) (list []*sysin.ListenerPlanModel, totalCount int, err error)
	...
	AdminActivitySave(ctx context.Context, in *sysin.ActivitySaveInp) (err error)
	AdminActivityRewardList(ctx context.Context, in *sysin.ActivityRewardListInp) (list []*sysin.ActivityRewardModel, totalCount int, err error)
	AdminActivityUserStatus(ctx context.Context, in *sysin.ActivityUserStatusInp) (list []*sysin.ActivityUserStatusModel, err error)
	AdminActivityDebug(ctx context.Context, in *sysin.ActivityDebugInp) (res *sysin.ActivityUserStatusModel, err error)
	AdminActivityReset(ctx context.Context, in *sysin.ActivityResetInp) (err error)
	...
	AdminProfilePublish(ctx context.Context, in *sysin.AdminProfilePublishInp) (err error)
	...
	AdminInclusionRecordList(ctx context.Context, in *sysin.InclusionRecordListInp) (list []*sysin.InclusionRecordModel, totalCount int, err error)
	...
	MyInclusionRecordList(ctx context.Context, in *sysin.InclusionRecordListInp) (list []*sysin.InclusionRecordModel, totalCount int, err error)
	...
	BotCollectSourceDown(ctx context.Context, sourceId, tenantId, accountId int64, deleteProfiles bool) (res *sysin.CollectSourceDownModel, err error)
	...
	CollectEventReprocess(ctx context.Context, in *sysin.CollectEventReprocessInp) (res *sysin.CollectEventReprocessModel, err error)
	...
	CollectReviewList(ctx context.Context, in *sysin.CollectReviewListInp) (res *sysin.CollectReviewPageModel, err error)
	CollectReviewAction(ctx context.Context, in *sysin.CollectReviewActionInp) (err error)
	CollectReviewEdit(ctx context.Context, in *sysin.CollectReviewEditInp) (err error)
	CollectReviewDelete(ctx context.Context, in *sysin.IdsInp) (err error)
	...
	MyMediaDirectUploadCreate(ctx context.Context, in *sysin.MediaDirectUploadCreateInp) (*sysin.MediaDirectUploadCreateModel, error)
	MyMediaDirectUploadSign(ctx context.Context, in *sysin.MediaDirectUploadSignInp) (*sysin.MediaDirectUploadSignModel, error)
	MyMediaDirectUploadComplete(ctx context.Context, in *sysin.MediaDirectUploadCompleteInp, poster *ghttp.UploadFile) (*sysin.MediaModel, error)
